...
class ValidationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create validation" do
    assert_difference('Validation.count') do
      post validations_url, params: { validation: { post_id: @validation.post_id, user_id: @validation.user_id, validation_type: @validation.validation_type } }
    end
  ...
  test "should update validation" do
    patch validation_url(@validation), params: { validation: { post_id: @validation.post_id, user_id: @validation.user_id, validation_type: @validation.validation_type } }
