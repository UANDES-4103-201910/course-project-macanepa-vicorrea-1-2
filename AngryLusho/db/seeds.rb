...
#Users
user01 = User.create(name:"Matias",last_name:"Canepa",username:"macanepa",email:"macanepa@miandes.cl",password:"123",last_login:Time.now,profile:profile01)
user02 = User.create(name:"Vicente",last_name:"Correa",username:"vicorrea",email:"vicorrera@miandes.cl",password:"123",last_login:Time.now,profile:profile02)
user03 = User.create(name:"Ignacio",last_name:"Figueroa",username:"BadBoiLusho",email:"ifigueroa@miandes.cl",password:"123",last_login:Time.now,profile:profile02)
